...
<form method="POST" action="/komatsukita/HometrainServlet">
    ...
    <map name="ImageMap">
      <area shape="rect" coords="189,347,218,371" href="/komatsukita/TraincheckServlet" onclick="submitForm('脚')" />
      <area shape="rect" coords="209,231,262,261" href="/komatsukita/TraincheckServlet" onclick="submitForm('お腹')"/>
      <area shape="rect" coords="303,261,358,291" href="/komatsukita/TraincheckServlet" />
      <area shape="rect" coords="385,263,426,289" href="/komatsukita/TraincheckServlet" />
      <area shape="rect" coords="452,294,515,320" href="/komatsukita/TraincheckServlet" />
    </map>
    <input type="hidden" id="parts_name" name="parts_name" value="" />
</form>
トレーニング選択ページに戻る

<script>
	function submitForm(parts) {
		document.getElementById('parts_name').value = parts;
